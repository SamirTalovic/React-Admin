...
function PostForm({
  ...
  */
  const handleSubmit = async (e) => {
    ...
    if (!title.trim())
      return updateNotification("error", "Service title is missing!");

    if (!content.trim())
      return updateNotification("error", "Service content is missing!");

    if (!meta.trim())
      return updateNotification("error", "Service description is missing!");

    if (!tags.trim())
      return updateNotification("error", "Service tags are missing!");
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                name="tags"
                placeholder="Add tags with comma: Pooling, Washing"
              />
            </div>
            <div>
              <label className="pb-2 text-gray-500" htmlFor="meta">
              ...
              <textarea
                ...
                value={meta}
                name="meta"
                placeholder="Write down little bit of service..."
